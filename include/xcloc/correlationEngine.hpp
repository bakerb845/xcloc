#ifndef XCLOC_CORRELATIONENGINE_HPP
#define XCLOC_CORRELATIONENGINE_HPP 1
#include <memory>
...
/*!
 * @class CorrelationEngine "correlationEngine.hpp" "xcloc/correlationEngine.hpp"
...
public:
     ...
     */
    void initialize(const CorrelationEngineParameters &parameters);
    /*!
...
private:
    ...
    std::unique_ptr<CorrelationEngineImpl> pImpl;   
};
}
#endif
