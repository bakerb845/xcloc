#ifndef XCLOC_GAUSSIANWAVELET_HPP
#define XCLOC_GAUSSIANWAVELET_HPP
#include <complex>
#include <vector>
#include <memory>
/*!
...
public:
     ...
     *                    false.
     */
    void setShiftWaveletToTraceStart(bool lshift, const double tol = 0.005) noexcept;
    /*!
     * @brief Determines whether or not to shift the wavelet to the start.
     */
    bool getShiftWaveletToTraceStart() const noexcept; 
    /*!
     ...
     */
    std::vector<double> getWavelet() const;
    /*!
     ...
     */
    std::vector<std::complex<double>> getWaveletFourierTransform() const;
    /*! @} */
private:
